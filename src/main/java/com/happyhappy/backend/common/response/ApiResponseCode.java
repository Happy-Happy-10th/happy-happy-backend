...
public enum ApiResponseCode {
    ...
    MEMBER_SUCCESS_000001(200, null, "인증번호가 확인되었습니다.", "The authentication number has been verified."),
    ...
    MEMBER_ERR_000001(200, "MEMBER-ERR-000001", "등록되어 있지 않은 아이디 입니다.", "This ID is not registered."),
    ...
    MEMBER_ERR_000004(200, "MEMBER-ERR-000004", "발급된 인증번호를 찾을 수 없습니다.", "Could not find issued authentication code."),
    MEMBER_ERR_000005(200, "MEMBER-ERR-000005", "인증번호가 일치하지 않습니다.", "The verification code does not match."),
    MEMBER_ERR_000006(200, "MEMBER-ERR-000006", "이미 등록되어 있는 아이디 입니다.", "This ID is already registered."),
    ROLES_ERR_000001(200, "MEMBER-ERR-000006", "해당 권한을 가진 유저가 존재합니다.", "A user with that privilege exists."),
    ...
    CODECREATE_ERR_000001(200, "CODECREATE_ERR_000001", "유효성검사 실패", "This action is validation check failed."),
    ;
